...
def run_one_xp(i_dataset, upsampler, i_xp, dataset, mse_tensor, sad_tensor, Y_init, A_init, E_init, wavelengths, H, dev):
    ...
    for i in range(n_train): 
        ...
        model = unmx.UnmixingFromFeatures(D=D, alpha=alpha, B=B, c=c, new_H=new_H, upsampler=upsampler)
...
def main(args, dev):
    ...
    for i_dataset, dataset in enumerate(datasets):
        ...
        for i_xp in range(n_xp):
            ...
            mse_tensor, sad_tensor = run_one_xp(i_dataset, upsampler, i_xp, dataset, mse_tensor, sad_tensor, Y_init, A_init, E_init, wavelengths, H, dev)
...
if __name__ == "__main__":
    ...
    run = wandb.init(project=f"DOFA_{args.upsampler}")
